...
static void *event_thread(void *Data) {
	...
	ML_LOG_INFO(NULL, "Creating event thread");
	event_base_loop(Events, EVLOOP_NO_EXIT_ON_EMPTY);
	return NULL;
}
...
#include "libevent2_init.c"
	pthread_create(&EventThread, NULL, (void *)event_thread, NULL);
